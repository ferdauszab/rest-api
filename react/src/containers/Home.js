// reactapp/src/containers/Home.js
...
// Declaring the Hompage class and extend Component to make sure we have state.

class Homepage extends React.Component {
    state = {
        products: [], // products is an empty array in state that will populate with our api get call below.
    ...
    // This onChange function takes an event parameter and then sets the state to the event target name/value 
